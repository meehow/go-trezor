...
type FirmwareRequest struct {
	...
	Offset *uint32 `protobuf:"varint,1,req,name=offset" json:"offset,omitempty"` // offset of requested firmware chunk
	Length *uint32 `protobuf:"varint,2,req,name=length" json:"length,omitempty"` // length of requested firmware chunk
}
...
// @next Success
// @next Failure
type ProdTestT1 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Payload []byte `protobuf:"bytes,1,opt,name=payload" json:"payload,omitempty"` // payload to be used in prodtest
}

func (x *ProdTestT1) Reset() {
	*x = ProdTestT1{}
...
func (x *ProdTestT1) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProdTestT1) ProtoMessage() {}

func (x *ProdTestT1) ProtoReflect() protoreflect.Message {
	mi := &file_messages_bootloader_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProdTestT1.ProtoReflect.Descriptor instead.
func (*ProdTestT1) Descriptor() ([]byte, []int) {
	return file_messages_bootloader_proto_rawDescGZIP(), []int{3}
}

func (x *ProdTestT1) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
...
var file_messages_bootloader_proto_rawDesc = []byte{
	...
	0x62, 0x6f, 0x6f, 0x74, 0x6c, 0x6f, 0x61, 0x64, 0x65, 0x72, 0x22, 0x27, 0x0a, 0x0d, 0x46, 0x69,
	...
	0x18, 0x01, 0x20, 0x02, 0x28, 0x0d, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x12, 0x16,
	0x0a, 0x06, 0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x18, 0x02, 0x20, 0x02, 0x28, 0x0d, 0x52, 0x06,
	...
	0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0x26, 0x0a, 0x0a, 0x50, 0x72, 0x6f, 0x64, 0x54, 0x65,
	0x73, 0x74, 0x54, 0x31, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x42, 0x3e,
	...
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x42, 0x17, 0x54, 0x72, 0x65, 0x7a, 0x6f, 0x72, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x42, 0x6f, 0x6f, 0x74, 0x6c, 0x6f, 0x61, 0x64, 0x65, 0x72,
}
...
var file_messages_bootloader_proto_goTypes = []any{
	...
	(*ProdTestT1)(nil),      // 3: hw.trezor.messages.bootloader.ProdTestT1
}
